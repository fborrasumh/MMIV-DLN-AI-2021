...
- The notebook is thus a practical machine learning example of the formalism: <img src="https://latex.codecogs.com/svg.latex?\Large&space;y \approx f(\mathbf X, \theta)" title="y \approx f(\mathbf X, \theta)" />
