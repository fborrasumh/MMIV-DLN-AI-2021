...
### Awesome MRI
 ...
 - **LayNII** - A software suite for [layer-fMRI] i.e. high-resolution fMRI in the sub-millimeter regime allowing researchers to resolve brain activity across cortical layers and columns non-invasively (https://github.com/layerfMRI/LAYNII)
...
- **qMRLab** Quantitative Magnetic Resonance Imaging Software for Data Simulation, Analysis and Visualization (https://github.com/qMRLab/qMRLab)
